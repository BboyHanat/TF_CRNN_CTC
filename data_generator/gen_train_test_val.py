...
num_thread = 16
data_file = [open("/hanat/data1/data_"+str(index)+'.txt', 'r') for index in range(num_thread)]

train_fp = open("/hanat/data1/train.txt", 'w')
val_fp = open("/hanat/data1/val.txt", 'w')
test_fp = open("/hanat/data1/test.txt", 'w')
