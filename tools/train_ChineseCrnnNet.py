"""
Name : train_ChineseCrnnNet.py
Author  : Hanat
Contect : hanati@tezign.com
Time    : 2019-08-14 14:22
Desc:
"""
import argparse
import os
...
def init_args():
    ...
    parser.add_argument('-w', '--weights_path', type=str, default='../ckpt/vgg_16.ckpt',
                        help='Path to pre-trained weights to continue training')
    parser.add_argument('-tm', '--train_data_num', type=int, default=24518,
                        help='Path to pre-trained weights to continue training')
