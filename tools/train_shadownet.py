...
def init_args():
    ...
    parser.add_argument('-w', '--weights_path', type=str, default=None, #'../ckpt/vgg_16.ckpt',
...
def train_shadownet(dataset_dir, weights_path, need_decode=False):
    """
    ...
    model_save_dir = '../ckpt/crnn_chinese_ocr'
